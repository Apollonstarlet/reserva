...
@section('menu')
  ...
  <nav class="navbar" style="width: 60%; height:auto;">
      ...
      <div class="availability">
        ...
        {{ csrf_field() }}
          <div class="box">
              <p id="num_date" style="display: none;"></p>
              <input type="text" name="fecha" class="input responsive" placeholder="Seleccionar fecha" style="font-size: 13px; cursor: pointer; height: 25px; border-style: solid; border-color: #233734;"/>
              <script>
                  $(function() {
      ...
      <div class="container-slider">
          ...
          <div class="availability">
            ...
            {{ csrf_field() }}
              <div class="box">
                  <p id="num_date" style="display: none;"></p>
                  <input type="text" name="fecha" class="input responsive" placeholder="Seleccionar fecha" style="font-size: 13px; cursor: pointer; height: 25px;"/>
                  <script>
                      $(function() {
                          let dates = Number($('p#num_date').innerHTML);
                          $('input[name="fecha"]').daterangepicker({
              ...
              <div class="box">
                  <input type="submit" class="input responsive" value="Buscar" style="font-size: 13px; cursor: pointer; height: 25px;">
              </div>
            </form>
          </div>
      </div>
